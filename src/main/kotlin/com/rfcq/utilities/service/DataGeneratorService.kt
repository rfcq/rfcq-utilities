...
class DataGeneratorService {
    ...
    fun getCpf(): String {
        ...
        val d1CalcPrimeiroDigito = d1!! * 10
        val d2CalcPrimeiroDigito = d2!! * 9
        val d3CalcPrimeiroDigito = d3!! * 8
        val d4CalcPrimeiroDigito = d4!! * 7
        val d5CalcPrimeiroDigito = d5!! * 6
        val d6CalcPrimeiroDigito = d6!! * 5
        val d7CalcPrimeiroDigito = d7!! * 4
        val d8CalcPrimeiroDigito = d8!! * 3
        val d9CalcPrimeiroDigito = d9!! * 2
        ...
        val d1CalcSegundoDigito = d1!! * 11
        val d2CalcSegundoDigito = d2!! * 10
        val d3CalcSegundoDigito = d3!! * 9
        val d4CalcSegundoDigito = d4!! * 8
        val d5CalcSegundoDigito = d5!! * 7
        val d6CalcSegundoDigito = d6!! * 6
        val d7CalcSegundoDigito = d7!! * 5
        val d8CalcSegundoDigito = d8!! * 4
        val d9CalcSegundoDigito = d9!! * 3
        val d10CalcSegundoDigito = primeiroDigitoVerificador * 2
        ...
        val cpfGerado = "$d1$d2$d3$d4$d5$d6$d7$d8$d9$primeiroDigitoVerificador$segundoDigitoVerificador"
